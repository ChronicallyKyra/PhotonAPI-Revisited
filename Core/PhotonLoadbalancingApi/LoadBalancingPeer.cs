...
namespace Photon.Realtime
{
    ...
    using ExitGames.Client.Photon.Hashtable = ExitGames.Client.Photon.ExitGames.Client.Photon.Hashtable;
    ...
    public class LoadBalancingPeer : PhotonPeer
    {
        ...
        /// </summary>
        /// <remarks>This override explicitly uses another parameter order to not mix it up with the implementation for ExitGames.Client.Photon.Hashtable only.</remarks>
        /// <param name="eventCode">Identifies this type of event (and the content). Your game's event codes can start with 0.</param>
        /// <param name="customEventContent">Any serializable datatype (including ExitGames.Client.Photon.Hashtable like the other OpRaiseEvent overloads).</param>
    ...
    public class ParameterCode
    {
        ...
        /// <summary>(249) Code for property set (ExitGames.Client.Photon.Hashtable).</summary>
        ...
        /// <summary>(248) Code for property set (ExitGames.Client.Photon.Hashtable).</summary>
        public const byte GameProperties = (byte)248;

        /// <summary>
        /// (251) Code for property-set (ExitGames.Client.Photon.Hashtable). This key is used when sending only one set of properties.
